...
# Create players
PLAYER1 = Player(x=X_PLAYER1, y=Y_PLAYER1, number=1, color='red', wall_color='orange')
PLAYER2 = Player(x=X_PLAYER2, y=Y_PLAYER2, number=2, color='blue', wall_color='cyan')
...
# Display the winner
print(f'The winner is: {GAME.winner.color}')
